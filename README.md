...
Проект **Foodgram** - База данных рецептов, создаваемых пользователями. Позволяет создавать свои рецепты, делиться ими, добавлять в избранное рецепты других авторов, подписываться на авторов и следить за их обновлениями. Список ингредиентов, из рецептов добавленных в список покупок, можно скачать в формате .pdf.
...
+ работать с избранными рецептами:
...
[Полная документация API (redoc.yaml)](https://github.com/gopolut/foodgram-project-react/blob/master/docs/redoc.html)
