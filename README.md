...
**Регистрационные данные для проверки:**
...
Позволяет создавать свои рецепты, делиться ими, добавлять в избранное рецепты других авторов, подписываться на авторов и следить за их обновлениями.
Список ингредиентов из рецептов, добавленных в список покупок, можно скачать в формате **.pdf**.
...
```
**POST-запрос** на добавление рецепта:
